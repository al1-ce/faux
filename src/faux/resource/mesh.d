...
// import faux.lib.opengl.glmesh;
// import faux.lib.opengl.shader;
// import faux.lib.opengl.opengl;

import faux.resource.texture;

// import faux.core.window: GlContext;
//
// import rl = raylib;
//
...
struct Mesh {
    ...
    this(float[] vertices, uint[] indices) {
        ...
        // }
        //
        // _mesh = GlMesh(vertices, indices);
        //
        // _vertLen = cast(uint) indices.length;
        //
        // _mesh.linkTextureDefault();
    }

    void render() {
        // _mesh.render(GL_TRIANGLES, _vertLen);
    }
}
